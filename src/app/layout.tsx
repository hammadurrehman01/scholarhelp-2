...
export const metadata: Metadata = {
  title: {
    template:
      "%s | A+ Grade Guaranteed: Taking My Classes Online For Me in USA",
  ...
  twitter: {
    ...
    description:
      "Pay Someone to Take My Online Class for Me in USA! Having a dedicated team who can assist you in every single step for online class takers and A+ Grade Guaranteed!",
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta
          name="copyright"
          content="Copyright 2024 @ Taking My Classes Online"
        />
        ...
        <meta
          property="og:url"
          content="https://www.takingmyclassesonline.com/"
        />
        <meta
          property="article:publisher"
          content="https://www.facebook.com/pages/"
        />
        <meta name="twitter:card" content="summary" />
        <meta
          name="twitter:description"
          content="Pay Someone to Take My Online Class for Me in USA! Having a dedicated team who can assist you in every single step for online class takers and A+ Grade Guaranteed!"
        />
        <meta
          name="twitter:image"
          content="https://www.takingmyclassesonline.com/images/og_TMCO.jpg?v=1"
        />
        <meta
          name="twitter:title"
          content="A+ Grade Guaranteed: Take My Online Class For Me in USA"
        />
        ...
        <meta
          ...
          content="Taking My Classes Online"
        />
        <link
          rel="alternate"
          hrefLang="x-default"
