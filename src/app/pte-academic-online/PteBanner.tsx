  ...
  return (
    ...
    <div className='grid lg:grid-cols-2 grid-cols-1 mx-auto max-w-screen-xl py-10 '>
      <div className='py-20 px-5 md:pt-40'>
        ...
        <h3 className='text-center dark:text-zinc-100 text-zinc-900 md:text-base font-medium'>Dynamic Online Learning Sessions  </h3>
        ...
        Link With User Friendly Services</h3>
        <div className='hidden lg:block w-[2px] h-20 bg-muted-foreground '></div>
        </div>
          <div className='flex items-center gap-1'>
        ...
        Online Expert Professor For Assistance
         </h3>
