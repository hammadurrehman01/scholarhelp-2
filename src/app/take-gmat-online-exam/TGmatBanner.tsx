  ...
  return (
    ...
    <div className='grid lg:grid-cols-2 grid-cols-1 mx-auto max-w-screen-xl py-10 '>
      <div className='py-20 px-5 md:pt-40'>
        ...
        <h3 className='text-center dark:text-zinc-100 text-zinc-900 md:text-base font-medium'>Authentic Legal Services
        ...
        <h3 className='ml-1 dark:text-zinc-100 text-zinc-900 md:text-base font-medium'>Dynamic Virtual Lectures
        </h3>
