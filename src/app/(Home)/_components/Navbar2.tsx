              ...
              <DropdownMenu open={servicesOpen} onOpenChange={setServicesOpen}>
                ...
                >
                  <DropdownMenuTrigger asChild>
                    <Button
                      variant="ghost"
                      className="inline-flex items-center group-hover:text-violet-500 group-hover:font-semibold"
                    >
                      Services
              ...
              <DropdownMenu open={samplesOpen} onOpenChange={setSamplesOpen}>
                ...
                >
                  <DropdownMenuTrigger asChild>
                    <Button
                      variant="ghost"
                      className="inline-flex items-center hover:text-violet-500 hover:font-semibold"
                    >
                      Samples
                      <ChevronDown className="ml-1 h-4 w-4" />
                    </Button>
          ...
          <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              >
                ...
                <ChevronRight
                  className={`h-4 w-4 transition-transform ${
                    mobileDropdowns.services ? "rotate-90" : ""
                  }`}
                />
              </Button>
            ...
            <div>
              ...
              >
                ...
                <ChevronRight
                  className={`h-4 w-4 transition-transform ${
                    mobileDropdowns.samples ? "rotate-90" : ""
                  }`}
                />
              </Button>
              {mobileDropdowns.samples && (
                <div className="pl-4">
                  <Button
                    ...
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    <Link href="/gre-sample-papers" className="block">
                      GRE Sample Papers
                    </Link>
                  </Button>
                  <Button
                    ...
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    <Link href="/ged-sample-papers" className="block">
                      GED Sample Paper
                    </Link>
                  </Button>
                  <Button
                    ...
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    <Link href="/gmat-sample-papers" className="block">
                      GMAT Sample Paper
                    </Link>
                  </Button>
                  <Button
                    ...
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    <Link href="/lsat-sample-papers" className="block">
                      LSAT Sample Paper
                    </Link>
                  </Button>
                </div>
